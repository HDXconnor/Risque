(function () {
    var app = angular.module("gameApp", ['ngCookies','gameApp.d3']).config(function ($httpProvider) {
    ...
    app.run(['$rootScope', '$http', function ($rootScope, $http) {
            ...
            evtSource.addEventListener("gamestate", function (e) {
                ...
                $rootScope.board = $rootScope.obj.Game.Board;
                ...
                $rootScope.currentPlayer = $rootScope.obj.Game.GameState.CurrentPlayer;
...
//            };
            ...
            this.endTurn = function(){
                var endTurnData = JSON.stringify({Command: "EndTurn", Data: {CurrentPlayer: $rootScope.currentPlayer}});
    ...
    app.controller("PhaseController", ["$rootScope", '$http', function ($rootScope, $http) {
            ...
            this.attack = function(){
                var send = JSON.stringify({Command: "Attack", Data: {AttackingCountry: $rootScope.attackCountryID, DefendingCountry: $rootScope.defendCountryID, CurrentPlayer: $rootScope.currentPlayer}});
                            postData(send);
            };
            function postData(data) {
                $http({
