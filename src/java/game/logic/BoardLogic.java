...
public class BoardLogic {
     ...
     * <p>
     * Checks if the neighboursMap contains a key equal to country1 with a value
     * equal to country2. If there is no key-value pair equal to the two
     * provided countries, the method will return false.
     * </p>
     *
     * @param country1 the 4 digit country code
     * @param country2 the 4 digit country code
     * @return          <code>true</code> if the two countries are neighbors;
    ...
    public static boolean checkWinner(Player player, Board board) {
        try {
            BufferedReader br = new BufferedReader(new FileReader("leaderboards.ini"));
            PrintWriter writer = new PrintWriter("leaderboards.ini", "UTF-8");
            int wins = 0;
